...
export const THEMES = Object.freeze({
  ...
  [CATEGORIES_THEME.SOIREE]: Object.freeze([
    ...
    "shrek qui chie sur l'ane devant la princesse",
    "papy trump qui se fait sodomiser par un alien",
    "louis et sof dans un glory hole",
    "un anus qui parle et qui raconte sa vie",
    "fahed sous puff dans le cul",
    "Azir qui va manger a KFC",
    "matin moue ou matin dure",
    "tibo in cat",
    "skin poisson qui zezotte",
  ]),
});
